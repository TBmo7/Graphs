...
def earliest_ancestor(ancestors, starting_node):
    ...
    stack = deque()
    stack.append((starting_node, 0 )) # node and starting distance from starting_node
    visited = set()
...
def createGraph(edges):
    #every key that is added to this dictionary will have a default value of a set()
